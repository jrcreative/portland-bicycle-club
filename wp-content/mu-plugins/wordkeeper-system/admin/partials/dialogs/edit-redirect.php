<template id="template-redirect-edit">
	<swal-html>
		<form action="#">
			<div class="holder-popups holder-redirect">
				...
				<div class="holder-inputs-popups">
					...
					<div class="item holder-input">
						...
						<div class="right-col">
							<input type="number" name="priority" id="priority" placeholder="2" />
							<div class="text-error">Error Message</div>
						</div>
					</div>
					<div class="item">
				...
				<div class="holder-btns">
					...
					<div class="col">
						<button type="button" class="btn button-primary sweetalert-btn" data-confirm data-waiting="Saving">Save</button>
					</div>
				</div>
			</div>
		</form>
