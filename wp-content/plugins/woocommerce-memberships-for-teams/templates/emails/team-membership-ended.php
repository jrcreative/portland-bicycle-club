 ...
 * @var \SkyVerge\WooCommerce\Memberships\Teams\Emails\Membership_Ended $email email object
...
<p>
	<?php echo esc_html( ucfirst( sprintf(
		/* translators: Placeholders: %1$s - the noun used to represent a team (singular), %2$s - site title */
		__( 'Oh no, your %1$s membership access at %2$s has now ended!', 'woocommerce-memberships-for-teams' ),
...
<p><a href="<?php echo esc_url( $team->get_renew_membership_url() ); ?>"><?php
	/* translators: Placeholder: %s - the noun used to represent a team (singular) */
	echo esc_html( ucfirst( sprintf( __( 'Click here to log in and renew your %s membership now', 'woocommerce-memberships-for-teams' ), wc_memberships_for_teams()->get_singular_team_noun() ) ) );
?></a>.</p>
