...
<form action="" method="post">
	...
	<p class="description">
		<?php
			// translators: %1$s is the field label, %2$s is an example field label, %3$s is the ticket edit link.
			printf( esc_html__( 'Add ticket fields to your email subject or content by inserting the field label like this: %1$s - e.g. %2$s. Use %3$s for the ticket edit link.', 'woocommerce-box-office' ), '<code>{Label}</code>', '<code>{First Name}</code>', '<code>{ticket_link}</code>' );
		?>
	</p>
