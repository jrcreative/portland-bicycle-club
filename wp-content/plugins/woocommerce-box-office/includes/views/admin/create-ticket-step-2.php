					...
					<td>
						<p style="margin-bottom: 10px">
							<label>
								...
								<?php echo wc_help_tip( esc_html__( 'The content in the email is based on the content of Ticket Emails panel found in selected ticket product.', 'woocommerce-box-office' ) ); // phpcs:ignore ?>
							</label>
						</p>
