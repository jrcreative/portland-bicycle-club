...
<div class="panel woocommerce_options_panel">
	...
	<p class="form-field">
		<strong>
			<label><?php esc_html_e( 'Subject:', 'woocommerce-box-office' ); ?></label>
	...
	<p class="form-field">
		<strong>
			<label for="sent_by"><?php esc_html_e( 'Sent by:', 'woocommerce-box-office' ); ?></label>
	...
	<p class="form-field">
		<strong>
			<label for="date_sent"><?php esc_html_e( 'Date sent:', 'woocommerce-box-office' ); ?></label>
	...
	<p class="form-field">
		<strong>
			<label for="sent_by"><?php esc_html_e( 'Total target:', 'woocommerce-box-office' ); ?></label>
