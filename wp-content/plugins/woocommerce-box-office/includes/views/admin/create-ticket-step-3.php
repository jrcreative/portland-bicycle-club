...
<div class="wrap woocommerce">
	...
	<div class="notice notice-success">
		<p>
			<?php
				// Translators: %s is the number of tickets created.
				echo esc_html( sprintf( _n( '%s ticket created.', '%s tickets created', sizeof( $tickets ), 'woocommerce-box-office' ), sizeof( $tickets ) ) ); // phpcs:ignore Generic.PHP.ForbiddenFunctions.FoundWithAlternative
			?>
		</p>
