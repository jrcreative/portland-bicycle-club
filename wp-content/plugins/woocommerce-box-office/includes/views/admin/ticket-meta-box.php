...
<div class="panel woocommerce_options_panel">
	...
	<p class="form-field">
		<label for="edit_ticket_url"><?php esc_html_e( 'Edit Ticket URL:', 'woocommerce-box-office' ); ?></label>
	...
	<?php if ( $order ) : ?>
	<p class="form-field">
		<label for="order_link"><?php esc_html_e( 'Order:', 'woocommerce-box-office' ); ?></label>
	...
	<p class="form-field">
		<label for="user_link"><?php esc_html_e( 'User:', 'woocommerce-box-office' ); ?></label>
	...
	<p class="form-field">
		<label for="field_attended"><?php esc_html_e( 'Attended', 'woocommerce-box-office' ); ?>:</label>
		...
		<span class="description"><?php esc_html_e( 'Mark this ticket as attended.', 'woocommerce-box-office' ); ?></span>
	</p>
