...
<tr class="<?php echo esc_attr( $row ?? '' ); ?>">
	...
	<td class="field_options">
		...
		<div class="email-options" style="<?php echo esc_attr( $email_style ); ?>">
			<span class="tips" data-tip="<?php echo wc_sanitize_tooltip( esc_html__( 'Use this email address to contact the ticket holder.', 'woocommerce-box-office' ) ); // phpcs:ignore ?>">
			...
			<span class="tips" data-tip="<?php echo wc_sanitize_tooltip( esc_html__( 'Use this email address for the ticket holder\'s gravatar.', 'woocommerce-box-office' ) ); // phpcs:ignore ?>">
