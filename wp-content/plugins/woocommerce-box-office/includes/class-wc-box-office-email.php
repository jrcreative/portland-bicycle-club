...
class WC_Box_Office_Email extends WC_Email {
	...
	public function __construct() {
		...
		$this->title          = esc_html__( 'Box Office Email', 'woocommerce-box-office' );
		$this->description    = esc_html__( 'Box Office emails are sent to the contact address for each ticket whenever a ticket is purchased or updated.', 'woocommerce-box-office' );
	...
	public function get_default_subject() {
		return esc_html__( 'Box Office Purchase Information', 'woocommerce-box-office' );
	}
	...
	public function get_default_heading() {
		return esc_html__( 'Ticket Details', 'woocommerce-box-office' );
	}
	...
	public function init_form_fields() {
		...
		$label   = $enabled ? esc_html__( 'Enabled', 'woocommerce-box-office' ) : esc_html__( 'Disabled', 'woocommerce-box-office' );

		$this->form_fields = array(
			'enabled'    => array(
				'title'       => esc_html__( 'Enable/Disable', 'woocommerce-box-office' ),
				'type'        => 'checkbox',
			...
			'subject'    => array(
				'title'       => esc_html__( 'Email Subject', 'woocommerce-box-office' ),
				'type'        => 'text',
				/* translators: default email subject */
				'description' => sprintf( esc_html__( 'This controls the subject line. Will be used if email subject for the ticket product is empty. Leave blank to use the default subject: <code>%s</code>.', 'woocommerce-box-office' ), esc_html( $this->get_default_subject() ) ),
				'placeholder' => $this->get_default_subject(),
				'default'     => '',
			),
			'heading'    => array(
				'title'       => esc_html__( 'Email Heading', 'woocommerce-box-office' ),
				'type'        => 'text',
				'desc_tip'    => true,
				'description' => esc_html__( 'This controls the main heading contained within the email notification. Leave blank to skip.', 'woocommerce-box-office' ),
				'placeholder' => $this->get_default_heading(),
				'default'     => '',
			),
			'email_type' => array(
				'title'       => esc_html__( 'Email type', 'woocommerce-box-office' ),
				'type'        => 'select',
				'description' => esc_html__( 'Choose which format of email to send.', 'woocommerce-box-office' ),
				'default'     => 'html',
