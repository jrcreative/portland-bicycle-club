...
class WC_Box_Office_Product_Admin {
	...
	public function ticket_type_option( $options = array() ) {
		$options['ticket'] = array(
			...
			'label'         => esc_html__( 'Ticket', 'woocommerce-box-office' ),
			'description'   => esc_html__( 'Each ticket purchased will have attendee details added to it.', 'woocommerce-box-office' ),
			'default'       => 'no',
		);
	...
	public function ticket_tab( $tabs = array() ) {
		$tabs['ticket'] = array(
			'label'  => esc_html__( 'Ticket Fields', 'woocommerce-box-office' ),
			'target' => 'ticket_field_data',
			'class'  => array( 'show_if_ticket' ),
		);

		$tabs['ticket-content'] = array(
			'label'  => esc_html__( 'Ticket Printing and Options', 'woocommerce-box-office' ),
			'target' => 'ticket_content_data',
			'class'  => array( 'show_if_ticket' ),
		);

		$tabs['ticket-email'] = array(
			'label'  => esc_html__( 'Ticket Emails', 'woocommerce-box-office' ),
