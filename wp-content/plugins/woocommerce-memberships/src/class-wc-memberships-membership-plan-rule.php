...
class WC_Memberships_Membership_Plan_Rule implements \SkyVerge\WooCommerce\PluginFramework\v6_2_1\Abilities\Contracts\JsonSerializable {
	...
	/**
	 * Returns a serializable representation of this rule.
	 *
	 * @since 1.28.0
	 *
	...
	{
		return MembershipPlanRuleSerializer::convert($this);
	}
	 ...
	 *
	 * Uses `oneOf` to represent the three possible rule type schemas.
	 * For a single type-specific schema, use {@see MembershipPlanRuleSerializer::getJsonSchema()}.
	 *
	 * @since 1.28.0
	 *
	 * @return array<string, mixed>
	...
	public static function getJsonSchema() : array
	{
		return [
			'oneOf' => [
				MembershipPlanRuleSerializer::getJsonSchema( 'content_restriction' ),
				MembershipPlanRuleSerializer::getJsonSchema( 'product_restriction' ),
				MembershipPlanRuleSerializer::getJsonSchema( 'purchasing_discount' ),
			],
		];
	}
