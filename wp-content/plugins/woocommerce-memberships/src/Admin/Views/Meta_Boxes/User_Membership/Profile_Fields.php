...
class Profile_Fields extends \WC_Memberships_Meta_Box {
	...
	private function output_checkboxes_profile_field( Profile_Field $profile_field, Profile_Field_Definition $profile_field_definition ) {
		...
		?>
		<dt><label <?php echo ( Profile_Fields_Handler::TYPE_CHECKBOX === esc_html( $type ) ) ? 'for="wc-memberships-profile-field-' . esc_html( $profile_field_definition->get_slug() ) . '"' : '' ?>><?php echo esc_html( stripslashes( $profile_field_definition->get_name() ) ); ?></label></dt>
		<dd>
	...
	private function output_select_profile_field( Profile_Field $profile_field, Profile_Field_Definition $profile_field_definition ) {
		...
		<dd>
			...
			<div class="wc-memberships-profile-field-input wc-memberships-profile-field-input-<?php echo esc_attr( $type ); ?>" style="display: none;">
				<select
	...
	private function output_file_profile_field( Profile_Field $profile_field, Profile_Field_Definition $profile_field_definition ) {
		...
		<dd>
			<span class="wc-memberships-profile-field-value" data-profile-field="<?php echo esc_attr( $profile_field->get_slug() ); ?>">
				<?php echo wp_kses_post( $formatted_value ); // expects formatted HTML link to media library item ?>
			</span>
			<div class="wc-memberships-profile-field-input wc-memberships-profile-field-input-file" style="display: none;">
				...
				/>
				<a href="#"
				   id="wc-memberships-profile-field-input-file-upload-<?php echo esc_attr( $profile_field->get_slug() ); ?>"
				...
				<a href="#"
				   id="wc-memberships-profile-field-input-file-remove-<?php echo esc_attr( $profile_field->get_slug() ); ?>"
