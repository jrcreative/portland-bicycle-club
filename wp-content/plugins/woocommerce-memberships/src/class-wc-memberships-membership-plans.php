...
use SkyVerge\WooCommerce\Memberships\Plans\Actions\CreatePlan;
...
class WC_Memberships_Membership_Plans {
	 ...
	 * @since 1.28.0
	 *
	 * @param int $planId the membership plan ID
	 * @return WC_Memberships_Membership_Plan the deleted plan object
	 * @throws PlanNotFoundException
	 * @throws PlanNotDeletableException
	 * @throws PlanDeleteFailedException
	 */
	public function deletePlan(int $planId): WC_Memberships_Membership_Plan
	{
		$plan = $this->get_membership_plan($planId);
		...
		$result = wp_delete_post($planId, true);

		if (! $result) {
			throw new PlanDeleteFailedException();
		}
	 ...
	 * @return WC_Memberships_Membership_Plan the created plan
	 * @throws InvalidArgumentException
	 * @throws PlanCreateFailedException
	 */
	public function createPlan(array $data): WC_Memberships_Membership_Plan
	{
		$plan = (new CreatePlan())->execute($data);
