	...
	public function output_course_auto_enroll_option( $rule, $index ) {
		...
		<span class="rule-control-group rule-control-group-course-auto-enroll <?php if ( ! $is_course_content_type ) : ?>hide<?php endif; ?> js-show-if-is-course">
			...
			<label class="label-checkbox">
				...
				<input type="hidden"
					   name="_<?php echo esc_attr( $type ); ?>_rules[<?php echo esc_attr( $index ); ?>][meta_data][<?php echo esc_html( Courseware::COURSE_AUTO_ENROLL_PLAN_RULE_META_KEY ); ?>]"
					   value="no" />

				<input type="checkbox"
					   name="_<?php echo esc_attr( $type ); ?>_rules[<?php echo esc_attr( $index ); ?>][meta_data][<?php echo esc_html( Courseware::COURSE_AUTO_ENROLL_PLAN_RULE_META_KEY ); ?>]"
					   id="_<?php echo esc_attr( $type ); ?>_rules_<?php echo esc_attr( $index ); ?>_course_auto_enroll"
