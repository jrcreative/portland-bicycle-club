...
class WC_Memberships_Membership_Plan implements \SkyVerge\WooCommerce\PluginFramework\v6_2_1\Abilities\Contracts\JsonSerializable {
	...
	/**
	 * Returns a serializable representation of this plan.
	 *
	 * @since 1.28.0
	 *
	...
	{
		return MembershipPlanSerializer::convert($this);
	}
	...
	{
		return MembershipPlanSerializer::getJsonSchema();
	}
	...
	public function has_product_discount( $product ) {
		return (bool) $this->get_product_discount( $product ); // nosemgrep
	}
