...
<?php if ($deleted) { ?>
        ...
        $('#pwtc-mapdb-delete-bbpost-div .revert-action').on('click', function(evt) {
            $('#pwtc-mapdb-delete-bbpost-div form').submit();
        });

        $('#pwtc-mapdb-delete-bbpost-div form').on('submit', function(evt) {
            $('#pwtc-mapdb-delete-bbpost-div .callout').html('<p><i class="fa fa-spinner fa-pulse"></i> please wait...</p>');
        })

<?php } else { ?>

        $('#pwtc-mapdb-delete-bbpost-div form').on('submit', function(evt) {
            $('#pwtc-mapdb-delete-bbpost-div .errmsg').html('<p><i class="fa fa-spinner fa-pulse"></i> please wait...</p>');
            $('#pwtc-mapdb-delete-bbpost-div input[type="submit"]').prop('disabled',true);
        })
...
<div id="pwtc-mapdb-delete-bbpost-div">
    <?php echo $return_to_bbpost; ?>
    <form method="POST">
        <?php wp_nonce_field('bbpost-delete-form', 'nonce_field'); ?>
