...
<div id="pwtc-mapdb-manage-files-div">
    <div class="row column">
        <form class="sort-frm" method="POST" novalidate>
            <input type="hidden" name="file_title" value="<?php echo esc_attr(stripslashes($file_title)); ?>">
                    ...
                    <div class="row">
                        <div class="small-12 medium-12 columns">
                            <label>Attachment Title 
                                <input type="text" name="file_title" value="<?php echo esc_attr(stripslashes($file_title)); ?>">
                            </label>
                        </div>
                    </div>
