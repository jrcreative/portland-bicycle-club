            ...
            array (
                ...
                'layouts' => array (
                    ...
                    array (
                        ...
                        'sub_fields' => array (
                            array (
                                'key' => 'field_5773f8210675e',
                                'label' => 'Attributes',
                                'name' => 'attributes',
                                'type' => 'text',
                                'instructions' => 'Uses the [pwtc_member_renew_nag] shortcode to display membership status, enter any attributes to pass to it.',
                                'required' => 0,
                                'conditional_logic' => 0,
                                'wrapper' => array (
                                    'width' => 50,
                            ...
                            array (
                                'key' => 'field_5773f8360675d',
                                'label' => 'Style',
                                'name' => 'style',
                                'type' => 'select',
                                'instructions' => 'Choose the membership status area background color.',
                                'required' => 1,
                                'conditional_logic' => 0,
                                'wrapper' => array (
                                    'width' => 50,
...
<b>Mountainous (e)</b> Extreme terrain with frequent steep hills and long sustained climbs',
            ...
            array (
                'key' => 'field_start_location_comment2',
                'label' => 'Start Location Comment',
                'name' => 'start_location_comment',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
...
<b>Mountainous (e)</b> Extreme terrain with frequent steep hills and long sustained climbs',
            ...
            array (
                'key' => 'field_start_location_comment',
                'label' => 'Start Location Comment',
                'name' => 'start_location_comment',
                'type' => 'text',
                'instructions' => '',
    ...
    acf_add_local_field_group(array (
        ...
        'fields' => array (
            ...
            array (
                ...
                'type' => 'text',
                'instructions' => 'Separate multiple roles with a space. Any roles with the "edit_posts" or "manage_woocommerce" capability automatically gets access to the admin menu bar.',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array (
                    'width' => '',
